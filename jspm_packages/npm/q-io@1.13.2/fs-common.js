...
(function(Buffer) {
  ...
  exports.update = function(exports, workingDirectory) {
    ...
    exports.move = function(source, target) {
      var self = this;
      return this.rename(source, target).catch(function(error) {
        if (error.crossDevice) {
          return self.copyTree(source, target).then(function() {
    ...
    exports.copy = function(source, target) {
      ...
      return Q.when(self.stat(source), function(stat) {
        ...
        return Q.all([self.open(source, {flags: "rb"}), self.open(target, {
          flags: "wb",
          mode: mode
        })]);
        ...
        return Q.when(reader.forEach(function(block) {
          ...
          return Q.all([reader.close(), writer.close()]);
        });
      });
    };
    ...
    exports.removeTree = function(path) {
      ...
      return Q.when(self.statLink(path), function(stat) {
        if (stat.isSymbolicLink()) {
          ...
          return self.list(path).then(function(list) {
